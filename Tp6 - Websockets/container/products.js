class Products {
  ...
  products = [
    {
      ...
      price: 32.93,
      thumbnail:
        "https://cdn0.iconfinder.com/data/icons/font-awesome-solid-vol-1/512/calculator-64.png",
    },
  ];
  ...
  async deleteById(id) {
    ...
    if (product == undefined) {
      ...
      this.products = filteredProducts;
      return {
        success: `Se ha eliminado el producto con el id: ${id}`,
